...
~> **Note:** We recommend using the Vault agent injector on Openshift
   ...
   [certify Helm charts](https://github.com/redhat-certification/chart-verifier/blob/main/docs/helm-chart-checks.md#table-2-helm-chart-default-checks)
   using CSI objects. If you would like to run the Secrets Store
